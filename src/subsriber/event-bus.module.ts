...
@Module({
  ...
  providers: [
    ...
    makeCounterProvider({
      ...
      labelNames: ['status', 'event_type', 'domain', 'entity', 'action', 'queue_name', 'routing_key'],
    }),
    makeHistogramProvider({
    ...
    makeCounterProvider({
      ...
      labelNames: ['failure_type', 'event_type', 'domain', 'entity', 'action', 'queue_name', 'routing_key'],
    }),
  ],
  exports: [
    RabbitMQModule,
